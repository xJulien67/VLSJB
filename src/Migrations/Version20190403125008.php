 ...
 */
final class Version20190403125008 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, sport_id INT NOT NULL, activitytype_id INT NOT NULL, distance DOUBLE PRECISION NOT NULL, duration DATETIME NOT NULL, place VARCHAR(255) NOT NULL, partner VARCHAR(255) DEFAULT NULL, average_pace DOUBLE PRECISION NOT NULL, average_speed DOUBLE PRECISION NOT NULL, heart_rate INT DEFAULT NULL, INDEX IDX_AC74095AAC78BCF8 (sport_id), UNIQUE INDEX UNIQ_AC74095A6E098B10 (activitytype_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
